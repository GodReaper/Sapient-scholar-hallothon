          ...
          render={({ field }) => (
            <FormItem className="flex w-full flex-col">
              ...
              <FormDescription className="body-regular mt-2.5 text-light-500">
                Be specific about what you want to learn or teach.
              </FormDescription>
        ...
        <FormField
          ...
          render={({ field }) => (
            <FormItem className="flex w-full flex-col gap-3">
              <FormLabel className="paragraph-semibold text-dark400_light800">Detailed explanation of what you want to learn or what you are teaching <span className="text-primary-500">*</span></FormLabel>
              <FormControl className="mt-3.5">
              <Editor
        ...
        <FormField
          ...
          render={({ field }) => (
            <FormItem className="flex w-full flex-col">
              ...
              <FormDescription className="body-regular mt-2.5 text-light-500">
                Add up to 3 tags to describe what you want to learn. You need to press enter to add a tag.
              </FormDescription>
              <FormMessage className="text-red-500" />
            </FormItem>
          )}
